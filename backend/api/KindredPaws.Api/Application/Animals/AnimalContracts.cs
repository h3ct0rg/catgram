...
public sealed record CreateShelterRequest(string Name, string Description, string Address, string City, string Country, string? Phone, string? WhatsApp, string? Email, double? Latitude, double? Longitude);
public sealed record UpdateShelterRequest(string Name, string Description, string Address, string City, string Country, string? Phone, string? WhatsApp, string? Email, double? Latitude, double? Longitude);
public sealed record ShelterResponse(Guid Id, string Name, string Description, string Address, string City, string Country, string? Phone, string? WhatsApp, string? Email, double? Latitude, double? Longitude, int AnimalCount);
...
public sealed record AnimalSearchFilter(
    Guid? ShelterId,
    string? Name,
