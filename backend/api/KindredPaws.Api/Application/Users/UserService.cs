...
public sealed class UserService(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole<Guid>> roleManager) : IUserService
{
    ...
    public async Task SetActiveAsync(Guid userId, bool active, CancellationToken cancellationToken)
    {
